...
public:
	...
	void Trim (U_INT ix, U_LONG from);
	void SetErrHandler(FSA_ERROR_HANDLER h) {m_err_handler = h;};
	FSA_ERROR_HANDLER GetErrHandler()       {return m_err_handler;};
...
private:
	FSA_ERROR_HANDLER  m_err_handler;
};
